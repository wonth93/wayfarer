    ...
    <Box sx={styles.root}>
      <Grid container spacing={5} style={{padding: "4rem", display: "flex", alignItems: "center"}}>
        <Grid item xs={12} md={7} className="animated-card-slow">
          ...
          <Typography gutterBottom variant="h6">Create and view all of your trips, add trip activities and view recommendations for where to visit during your stay.</Typography>
